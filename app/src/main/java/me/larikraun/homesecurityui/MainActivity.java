...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		KeyHolderModel keyHolder2 = new KeyHolderModel ("Omolara Adejuwon", "Everyday", "12:00pm to 3:00pm", "0");
		KeyHolderModel keyHolder3 = new KeyHolderModel ("Omolara Adejuwon", "Everyday", "12:00pm to 3:00pm", "1");
		KeyHolderModel keyHolder4 = new KeyHolderModel ("Omolara Adejuwon", "Everyday", "12:00pm to 3:00pm", "1");
		...
		mImageView.setOnClickListener (new View.OnClickListener () {
			...
			public void onClick (View v) {
				...
				View v2 = inflater.inflate (R.layout.lock_screen, null, false);
